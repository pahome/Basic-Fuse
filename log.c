...
void log_fuse_context(struct fuse_context *context)
{
    ...
    log_struct(((struct aws_state *)context->private_data), logfile, %08x, );
    log_struct(((struct aws_state *)context->private_data), rootdir, %s, );
